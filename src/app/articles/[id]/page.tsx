...
export default function ArticleDetail({ params }: ArticleDetailProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4">
      <div className="mb-8">
        <h1 className="text-[55px] font-[800] mt-4 mb-6 text-center">{article.title} with {article.author}</h1>
        <Image
          src={article.Image}
          alt={article.title}
      ...
      <div className='pr-10 my-8'>
        ...
        <p className='text-justify font-[400] mt-4 text-[18px]'>{article.goals?.content}</p>
      </div>
      ...
      <div className='pr-10 my-8'>
        ...
        <p className='text-justify font-[400] mt-4 text-[18px]'>{article.projects?.items[0].description}</p>
                <p className='text-justify font-[400] mt-4 text-[18px]'>{article.projects?.items[0].details}</p>
      </div>
      <div>
        <ArticlesSection/>
      </div>
